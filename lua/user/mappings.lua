...
local mappings = {
	n = {
		...
		["<C-w>m"] = {
			"<CMD>tabedit %<CR>",
			desc = "Create a new tab for the current buffer",
		},

		["]q"] = { "<CMD>cnext<CR>", desc = "Next quickfix item" },
		["[q"] = { "<CMD>cprev<CR>", desc = "Prev quickfix item" },
		["<C-q>"] = { require("user.utils").toggle_qf, desc = "Toggle qf" },
		["<leader>gg"] = { "<CMD>tab G<CR>", desc = "Fugitive" },
	},
	v = {
